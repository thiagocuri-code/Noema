    ...
    <div className="min-h-screen bg-white flex flex-col overflow-x-hidden">
      ...
      <header className="border-b border-[#E5E7EB] bg-white">
        <div className="mx-auto flex py-3 max-w-5xl items-center justify-between px-6">
          ...
          <Link
            href="/login"
            className="rounded-xl bg-[#1B3B8A] px-5 py-2 text-sm font-semibold text-white transition-all hover:bg-[#0A1A4A]"
          >
            Entrar
          </Link>
        </div>
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-6 py-10 sm:py-16 text-center">
        <div className="mx-auto max-w-2xl space-y-6">
          <div className="flex justify-center">
            <img src="/athena-full.png" alt="athena" className="h-40 sm:h-56 lg:h-64 object-contain" />
          </div>

          <h1 className="font-[var(--font-heading)] text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-[#0A1A4A]">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              href="/login"
              className="w-full sm:w-auto rounded-2xl bg-[#1B3B8A] px-8 py-4 font-[var(--font-heading)] text-base font-semibold text-white shadow-lg shadow-[#1B3B8A]/30 transition-all hover:bg-[#0A1A4A] hover:shadow-[#0A1A4A]/40"
            >
              Começar agora →
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-8">
            {[
              ...
              >
                ...
                <h3 className="mt-3 text-sm font-bold text-[#0A1A4A]">{f.title}</h3>
      ...
      <footer className="border-t border-[#E5E7EB] bg-white py-6">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-3 px-6 sm:flex-row sm:justify-between">
          ...
          <div className="flex gap-4">
            <Link
              href="/privacy"
              className="text-xs text-gray-400 hover:text-[#1B3B8A] hover:underline"
            >
